...
class ProtocolTest {
  ...
  def testMessages: Unit = {
    ...
    // TODO // roundTripMessage(protocol.CommandCompletionsResponse(Vector(protocol.Completion("llo", "Hello", true))))
    ...
    // TODO // roundTripMessage(protocol.ListenToValue(scopedKey))
