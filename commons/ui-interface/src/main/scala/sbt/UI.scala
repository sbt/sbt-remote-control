...
sealed trait UIContext {
  ...
  /** Attempts to read a line of input using the given autocompletion service. */
  def readLine(prompt: String, handler: sbt.interaction.CompletionHandler): Option[String]
