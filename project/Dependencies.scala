...
object Dependencies {
  ...
  val coreNextVersion      = "0.1.0-M1"
  val coreNext             = Def.setting { Defaults.sbtPluginExtra(sbtOrg % "core-next" % coreNextVersion, sbtBinaryVersion.value, scalaBinaryVersion.value) }
