...
object TheBuild extends Build {
  ...
  lazy val itRunner: Project = (
    ...
    settings(
      ...
      localRepoArtifacts += "com.typesafe.play" % "play_2.10" % "2.2.0-RC2",
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.play" % "sbt-plugin" % "2.2.0-RC1", "0.13", "2.10"),
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-atmos" % "0.3.0-RC4", "0.13", "2.10"),
      // TODO - does this exist?
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-atmos" % "0.3.0-RC4", "0.12", "2.9.2"),
