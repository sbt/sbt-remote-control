...
object TheBuild extends Build {
  ...
  lazy val itRunner: Project = (
    ...
    settings(
      ...
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-atmos" % Dependencies.sbtAtmosDefaultVersion, "0.13", "2.10"),
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-atmos" % Dependencies.sbtAtmosDefaultVersion, "0.12", "2.9.2"),
