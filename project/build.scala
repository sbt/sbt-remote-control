...
object TheBuild extends Build {
  ...
  lazy val itRunner: Project = (
    ...
    settings(
      ...
      localRepoArtifacts += "org.scala-lang" % "scala-compiler" % "2.11.1",
      localRepoArtifacts += "com.typesafe.akka" % "akka-actor_2.11" % "2.3.4",
      localRepoArtifacts += "com.typesafe.play" % "play_2.10" % "2.2.3",
      localRepoArtifacts += "play" % "play_2.10" % "2.1.5",
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.play" % "sbt-plugin" % "2.2.3", "0.13", "2.10"),
      localRepoArtifacts += Dependencies.playSbtPlugin12,
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-echo" % Dependencies.sbtEcho132Version, "0.13", "2.10"),
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-echo" % Dependencies.sbtEcho135Version, "0.13", "2.10"),
      localRepoArtifacts += Defaults.sbtPluginExtra("com.typesafe.sbt" % "sbt-echo" % Dependencies.sbtEcho12Version, "0.12", "2.9.2"),
